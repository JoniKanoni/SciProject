...
def read_data():
    ...
    Returns:
        energies:       1darray of energies
        wavefuncs:      ndarray of wavefuncs (xvalues are stored in the first column)
        expvalues:      2darray that contains the expectationvalue and variance
                        of position
        potential:      2darray that contains the xvalues and corresponding potential
    ...
    return energies, wavefuncs, expvalues, potential, path

def ploty(energies, wavefuncs, expvalues, potential, path):
    '''
